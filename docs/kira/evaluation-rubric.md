...
In all cases: write an amendment commission (new ID, `references` pointing to the failing commission), describe exactly what needs to change or what answer O'Brien needs.
...
If you're unsure: ask whether O'Brien should pick up from where he left off. If yes, it's an amendment. If the work is genuinely new and independent, it's a new commission.
