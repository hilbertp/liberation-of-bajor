# Queue Lifecycle — DEPRECATED

> This document has been superseded by [`slice-lifecycle.md`](./slice-lifecycle.md), which is the canonical business-requirements document for the slice pipeline.
>
> The content below is preserved for historical reference only. It describes an earlier 3-state flow (PENDING → IN_PROGRESS → DONE → ERROR) using the old "brief" terminology and does not reflect the current pipeline.
>
> *Deprecated: 2026-04-16.*

---

## Archived previous version (v1.0, locked 2026-04-06)
